...
from qfluentwidgets import (FluentIconBase, ConfigItem, pyqtSignal,
                            SwitchButton, qconfig, IndicatorPosition, SettingCard)
...
class CustomSwitchSettingCard(SettingCard):
    ...
    def __init__(self, icon: Union[str, QIcon, FluentIconBase], title, target:str, content=None, parent=None):
        ...
        check_state = Read_Config(os.path.join(os.getcwd(),"config","custom_config.json"))[self.target]
