...
class CustomComboBoxSettingCard(SettingCard):
    ...
    def __init__(self, icon: Union[str, QIcon, FluentIconBase], title, target, content=None, texts=None, parent=None):
        ...
        CurrentText = Read_Config(os.path.join(os.getcwd(),"config","custom_config.json"))[self.target]
